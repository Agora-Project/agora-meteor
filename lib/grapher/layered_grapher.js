...
LayeredGrapher = {
    ...
    calculateSubtreesFromTable: function(postCollection, table) {
        ...
        for (let i = table.length - 1; i >= 0; i--) {
            ...
            for (let post of layer) {
               ...
               postCollection.update({_id: post._id}, {$set: {subtreeWidth: this.calculateSubtreeWidth(postCollection, post)}});
           }
        }
    },
    ...
    //Reposition relations, then return in usual format.
    repositionPost: function(postCollection, post) {
